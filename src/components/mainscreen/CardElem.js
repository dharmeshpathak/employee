...
function CardElem({ emp, handleOnChange, handleOpen }) {
    ...
    <Card sx={{ maxWidth: 400 }} style={{ position: "relative" }}>
      ...
      <CardContent style={{ textAlign: "center" }}>
        <Typography
          ...
          className="heading"
          component="div"
          style={{ marginTop: "10px", fontFamily: "math", fontWeight: "500" }}
        >
          {emp.name}
        </Typography>
      ...
      <CardActions style={{ display: "flex", justifyContent: "center" }}>
        <Button size="small" onClick={() => handleOpen(emp.id)}>
          Edit
        </Button>
        <Button size="small" onClick={() => dispatch(deleteEmployee(emp.id))}>
          Delete
        </Button>
      </CardActions>
